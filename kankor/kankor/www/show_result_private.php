...
<div class="page-container">
	...
	<div class="page-content-wrapper" style="font-family:myFirstFont">
		...
		<?php
		  ...
		  $rs_exam=$crud->select_limit("student_exams","id","order by id desc limit 1");
		  $idexam=$rs_exam[0]['id'];
		  $result=0;
		  $rs_answer=$crud->select("student_questions","*","student_exams_id='$idexam'");
		  
		  
		  $rs_score=$crud->select_limit("private_kankor_setting","score,number_questions","order by id desc limit 1");
			$score=$rs_score[0]['score'];
			$number_questions=$rs_score[0]['number_questions'];
			$fulresult=$number_questions*$score;
		  ...
		  $fifty_percent=($fulresult*30)/100;
		 ...
		 for($i=0;$i<sizeof($rs_faculies);$i++){
			...
			if($result>$fifty_percent and $fid>0){
			$result_faculty=$fid;	
			...
			<center>
				<div class="col-md-12">
					...
					<div class="portlet box red">
						...
						<tr>
						<td>
						<?php echo $_SESSION['number_question']; ?>
						</td>
						<td>
						<?php echo $count_true; ?>
						</td>	
